            ...
            <section className="border-b-2 border-gray-900">
                ...
                <div className="px-6 mt-4">
                    ...
                    <div className="my-5 flex gap-6">  
                        <div className="text-xl text-gray-500"><span className="text-white">99</span> Following</div>
                        <div className="text-xl text-gray-500"><span className="text-white">99</span> Folower</div>
                    </div>
                </div>
            </section>
